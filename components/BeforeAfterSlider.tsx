  ...
  return (
    <div>
      ...
      >
        ...
        {/* Top layer: "before" image, clipped to slider position via clip-path
            (avoids reading containerRef.current during render, which React
            disallows and which also broke on resize) */}
        <div
